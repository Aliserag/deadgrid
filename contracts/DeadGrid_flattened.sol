 ...
 */
contract DeadGrid is ERC721URIStorage, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    
    // ============ State Variables ============
    
    Counters.Counter private _survivorIds;
    ...
    function createSurvivor(
        ...
        _survivorIds.increment();
        uint256 newSurvivorId = _survivorIds.current();
