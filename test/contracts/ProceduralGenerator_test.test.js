...
describe("ProceduralGenerator - New Feature", function () {
  let contract;
  let owner;
  let addr1;
  ...
  describe("Feature Tests", function () {
    ...
    it("Should handle story_scenario operations", async function () {
      // Test the new functionality added to contract
      // This validates the story_scenario integration
