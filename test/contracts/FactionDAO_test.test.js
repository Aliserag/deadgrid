...
describe("FactionDAO - New Feature", function () {
  let contract;
  let owner;
  let addr1;
  ...
  beforeEach(async function () {
    ...
    const Contract = await ethers.getContractFactory("FactionDAO");
  ...
  describe("Feature Tests", function () {
    ...
    it("Should handle quest operations", async function () {
      // Test the new functionality added to contract
      // This validates the quest integration
